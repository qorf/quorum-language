function plugins_quorum_Libraries_Game_Graphics_Painter3D_() {
    ...
    this.SetCamera$quorum_Libraries_Game_Graphics_Camera = function(camera) {

    };
    this.GetCamera = function() {

    };
    this.SetEnvironment$quorum_Libraries_Game_Graphics_Environment = function(environment) {
