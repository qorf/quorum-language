...
#define CUSTOM_SETNAME WM_USER + 1
#define CUSTOM_SETFOCUS WM_USER + 2

#define CUSTOM_INVOKEBUTTON WM_USER + 3
#define CUSTOM_UPDATECARET WM_USER + 4
#define CUSTOM_SETTEXT WM_USER + 5
