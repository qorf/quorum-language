	...
	public JsonValue parse (File file) 
        {
            ...
            {
                throw new GameRuntimeError("Error parsing file: " + file, ex);
            }
	}
	...
	protected JsonValue parse (final DataInputStream din, final byte type) throws IOException 
        {
            if (type == '[')
                ...
                throw new GameRuntimeError("Unrecognized data type");
	}
	...
	protected String parseString (final DataInputStream din, final boolean sOptional, final byte type) throws IOException 
        {
            ...
            if (size < 0)
                throw new GameRuntimeError("Unrecognized data type, string expected");
