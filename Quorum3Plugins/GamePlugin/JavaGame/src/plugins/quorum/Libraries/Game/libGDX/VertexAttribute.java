...
public final class VertexAttribute {
	...
	public VertexAttribute (int usage, int numComponents, String alias, int index) {
		this(usage, numComponents, usage == Usage.ColorPacked ? GraphicsManager.GL_UNSIGNED_BYTE : GraphicsManager.GL_FLOAT, 
	...
	public static VertexAttribute ColorPacked () {
		return new VertexAttribute(Usage.ColorPacked, 4, GraphicsManager.GL_UNSIGNED_BYTE, true, ShaderProgram.COLOR_ATTRIBUTE);
	}

	public static VertexAttribute ColorUnpacked () {
		return new VertexAttribute(Usage.Color, 4, GraphicsManager.GL_FLOAT, false, ShaderProgram.COLOR_ATTRIBUTE);
	}
