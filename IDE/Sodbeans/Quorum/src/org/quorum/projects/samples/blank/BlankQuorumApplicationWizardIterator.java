...
public class BlankQuorumApplicationWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public BlankQuorumApplicationWizardIterator() {
    }

    public static BlankQuorumApplicationWizardIterator createIterator() {
        return new BlankQuorumApplicationWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
            new BlankQuorumApplicationWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(BlankQuorumApplicationWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
