 ...
 * @author stefika
 */
public class SendToIPhoneApplication extends QuorumAction implements ActionListener{
    public SendToIPhoneApplication(QuorumProject project) {
        super(project);
    }
...
//                -provisioningprofile cb082625-1b0d-489c-99c8-65d204cfdb7c -d ~/Desktop/IPA -createipa
    ...
    protected String getDisplayName() {
        return "Send to iPhone Application";
    }
}
