...
@OptionsPanelController.SubRegistration(
        ...
        keywordsCategory = "Accessibility/General"
)
@org.openide.util.NbBundle.Messages({"AdvancedOption_DisplayName_General=General", "AdvancedOption_Keywords_General=Speech, Magnification"})
