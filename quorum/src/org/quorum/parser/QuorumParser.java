        ...
        try {
            ...
            switch (alt8) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: ID, END, generic_declaration, CLASS, class_stmnts, inherit_stmnts
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt31) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: RETURNS, ID, block, ACTION, assignment_declaration, END, formal_parameter
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: BLUEPRINT, assignment_declaration, formal_parameter, ACTION, RETURNS, ID
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: assignment_declaration, RETURNS, ACTION, NATIVE, ID, formal_parameter
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt44) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: expression, expression, RIGHT_PAREN, LEFT_PAREN, COMMA, COLON, ID, qualified_name
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: COLON, PARENT, COLON, expression, RIGHT_PAREN, expression, COMMA, LEFT_PAREN, ID, qualified_name
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: RIGHT_PAREN, COLON, qualified_name, expression, COMMA, ID, expression, COLON, ME, LEFT_PAREN
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt82) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: COLON, ID, qualified_name, PARENT, COLON, COLON, qualified_name
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: qualified_name, ID, LEFT_PAREN, COLON, RIGHT_PAREN, function_expression_list
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 5 :
                    ...
                    // AST REWRITE
                    // elements: LEFT_PAREN, PARENT, RIGHT_PAREN, ID, qualified_name, COLON, COLON, function_expression_list
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 6 :
                    ...
                    // AST REWRITE
                    // elements: function_expression_list, LEFT_PAREN, COLON, COLON, qualified_name, ID, RIGHT_PAREN, ME
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
