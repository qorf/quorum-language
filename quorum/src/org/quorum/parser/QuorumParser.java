// $ANTLR 3.4 /Users/melissa/NetBeansProjects/quorum-code/trunk/quorum/src/org/quorum/parser/Quorum.g 2012-12-04 09:30:23
...
public TreeAdaptor getTreeAdaptor() {
        ...
        try {
            ...
            switch (alt31) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: ID, assignment_declaration, formal_parameter, RETURNS, ACTION, block, END
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: assignment_declaration, formal_parameter, ACTION, RETURNS, BLUEPRINT, ID
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: ID, NATIVE, RETURNS, assignment_declaration, ACTION, formal_parameter
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt43) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: RIGHT_PAREN, LEFT_PAREN, ID, COLON, expression, qualified_name, expression, COMMA
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: expression, expression, COMMA, COLON, COLON, PARENT, ID, qualified_name, RIGHT_PAREN, LEFT_PAREN
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: ME, COMMA, RIGHT_PAREN, COLON, expression, ID, qualified_name, COLON, expression, LEFT_PAREN
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    public final QuorumParser.detect_parameter_return detect_parameter() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: ID, OF_TYPE, OR, qualified_name, qualified_name
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final QuorumParser.generic_declaration_return generic_declaration() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: COMMA, LESS, ID, ID, GREATER
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt81) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: qualified_name, COLON, ID, PARENT, qualified_name, COLON, COLON
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: function_expression_list, ID, LEFT_PAREN, qualified_name, COLON, RIGHT_PAREN
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 5 :
                    ...
                    // AST REWRITE
                    // elements: PARENT, COLON, RIGHT_PAREN, COLON, qualified_name, ID, function_expression_list, LEFT_PAREN
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 6 :
                    ...
                    // AST REWRITE
                    // elements: qualified_name, ME, ID, LEFT_PAREN, function_expression_list, RIGHT_PAREN, COLON, COLON
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
