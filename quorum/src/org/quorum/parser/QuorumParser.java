...
public TreeAdaptor getTreeAdaptor() {
        ...
        try {
            ...
            switch (alt8) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: inherit_stmnts, class_stmnts, ID, generic_declaration, END, CLASS
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt31) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: formal_parameter, assignment_declaration, ACTION, block, ID, RETURNS, END
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: RETURNS, formal_parameter, ID, ACTION, BLUEPRINT, assignment_declaration
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: RETURNS, NATIVE, assignment_declaration, ACTION, ID, formal_parameter
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt43) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: COLON, ID, expression, COMMA, LEFT_PAREN, RIGHT_PAREN, expression, qualified_name
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: RIGHT_PAREN, COLON, COLON, expression, ID, qualified_name, PARENT, expression, COMMA, LEFT_PAREN
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: ME, ID, RIGHT_PAREN, expression, COMMA, expression, COLON, LEFT_PAREN, COLON, qualified_name
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    public final QuorumParser.detect_parameter_return detect_parameter() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: qualified_name, qualified_name, OF_TYPE, OR, ID
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final QuorumParser.generic_declaration_return generic_declaration() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: GREATER, ID, ID, LESS, COMMA
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt81) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: COLON, qualified_name, COLON, PARENT, qualified_name, ID, COLON
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: LEFT_PAREN, qualified_name, ID, RIGHT_PAREN, COLON, function_expression_list
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 5 :
                    ...
                    // AST REWRITE
                    // elements: function_expression_list, COLON, COLON, PARENT, qualified_name, RIGHT_PAREN, LEFT_PAREN, ID
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 6 :
                    ...
                    // AST REWRITE
                    // elements: COLON, COLON, ID, LEFT_PAREN, RIGHT_PAREN, function_expression_list, ME, qualified_name
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
