...
<h2>Quorum IDE <span class="IDE-subtitle full-page-IDE-subtitle">Enter Quorum code below and press "Run" to execute it</span></h2>

   <textarea id="IDE-input" class="ide inputArea full-page-IDE-input" role="textbox" aria-multiline="true">var hi = "Hello World!";
hi</textarea>
