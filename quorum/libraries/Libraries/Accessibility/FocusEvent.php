<?php $classPageTitle = "FocusEvent"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Accessibility.FocusEvent</h1>
<input type="hidden" id="classkey" value="Libraries.Accessibility.FocusEvent" /><h2> <span class="controllable" data-componentType="class-name">Class FocusEvent</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The FocusEvent class is used to represent an event for when the focus changed. These components are typically used as described in the Legam Screen Reader XML documentation.</span></p>

<span class="controllable" data-componentType="class-example"><em>Example Code</em>:</span>
<pre class="code">FocusEvent fevent
fevent:SetCategory("Focus")
fevent:SetAction("Component")
fevent:SetComponent("Menu")
fevent:SetComponentName("File")
say(fevent:GetDescription())</pre>
