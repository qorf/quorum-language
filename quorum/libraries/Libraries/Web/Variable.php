<?php $classPageTitle = "Variable"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Variable</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Variable" /><h2> <span class="controllable" data-componentType="class-name">Class Variable</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Variable class represents HTML's (Hypertext Markup Language) var tag which is used represent a variable in the text. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_var.asp">The var attribute</a>.</span></p>
