<?php $classPageTitle = "TableBody"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.TableBody</h1>
<input type="hidden" id="classkey" value="Libraries.Web.TableBody" /><h2> <span class="controllable" data-componentType="class-name">Class TableBody</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The TableBody class represents HTML's (Hypertext Markup Language) tbody tag which is used to group the main part of a table content. This will be displayed after the TableHeader and before the TableFooter. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_tbody.asp">The tbody attribute</a>.</span></p>
