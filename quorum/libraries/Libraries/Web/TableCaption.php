<?php $classPageTitle = "TableCaption"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.TableCaption</h1>
<input type="hidden" id="classkey" value="Libraries.Web.TableCaption" /><h2> <span class="controllable" data-componentType="class-name">Class TableCaption</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The TableCaption must be added as the first thing in a WebTable. WebTable can only have one caption per table.  The TableCaption class represents HTML's (Hypertext Markup Language) caption tag which is used to give a title above a table. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_caption.asp">The caption attribute</a>.</span></p>
