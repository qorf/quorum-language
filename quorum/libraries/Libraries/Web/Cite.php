<?php $classPageTitle = "Cite"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Cite</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Cite" /><h2> <span class="controllable" data-componentType="class-name">Class Cite</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Cite class represents HTML's (Hypertext Markup Language) cite tag which is used to italicize the title of cited information being displayed. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_cite.asp">The cite attribute</a>.</span></p>
