<?php $classPageTitle = "NoScript"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.NoScript</h1>
<input type="hidden" id="classkey" value="Libraries.Web.NoScript" /><h2> <span class="controllable" data-componentType="class-name">Class NoScript</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The NoScript class represents HTML's (Hypertext Markup Language) noscript tag which is used to show different content if a user is not allowing for scripts to be run or the browser does not support the script. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_noscript.asp">The noscript attribute</a>.</span></p>
