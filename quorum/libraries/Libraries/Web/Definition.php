<?php $classPageTitle = "Definition"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Definition</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Definition" /><h2> <span class="controllable" data-componentType="class-name">Class Definition</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Definition class represents HTML's (Hypertext Markup Language) dd tag which is used to make an indented definition for an item in a DefinitionList class. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_dd.asp">The dd attribute</a>.</span></p>
