<?php $classPageTitle = "Section"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Section</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Section" /><h2> <span class="controllable" data-componentType="class-name">Class Section</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Section class represents HTML's (Hypertext Markup Language) section tag which is used to define sections in the page to seperate Headers, Footers, chapters of text, etc. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_section.asp">The section attribute</a>.</span></p>
