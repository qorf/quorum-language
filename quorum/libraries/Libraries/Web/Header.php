<?php $classPageTitle = "Header"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Header</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Header" /><h2> <span class="controllable" data-componentType="class-name">Class Header</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Header class represents HTML's (Hypertext Markup Language) header tag which contains the header information for a section or document. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_header.asp">The header attribute</a>.</span></p>
