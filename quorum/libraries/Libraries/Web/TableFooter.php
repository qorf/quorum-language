<?php $classPageTitle = "TableFooter"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.TableFooter</h1>
<input type="hidden" id="classkey" value="Libraries.Web.TableFooter" /><h2> <span class="controllable" data-componentType="class-name">Class TableFooter</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The TableFooter class represents HTML's (Hypertext Markup Language) tfoot tag which is used to footer content of a table. This will go after the TableBody. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_tfoot.asp">The tfoot attribute</a>.</span></p>
