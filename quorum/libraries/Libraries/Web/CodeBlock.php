<?php $classPageTitle = "CodeBlock"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.CodeBlock</h1>
<input type="hidden" id="classkey" value="Libraries.Web.CodeBlock" /><h2> <span class="controllable" data-componentType="class-name">Class CodeBlock</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The CodeBlock class represents HTML's (Hypertext Markup Language) code tag which is used to define code. It is recommended that CodeBlock be used in PreformattedText to keep the current formatting of the code.  You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_phrase_elements.asp">The code attribute</a>.</span></p>
