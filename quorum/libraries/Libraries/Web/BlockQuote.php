<?php $classPageTitle = "BlockQuote"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.BlockQuote</h1>
<input type="hidden" id="classkey" value="Libraries.Web.BlockQuote" /><h2> <span class="controllable" data-componentType="class-name">Class BlockQuote</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The BlockQuote class represents HTML's (Hypertext Markup Language) blockquote tag which is used to specify a larger amount of text that is quoted from a source. You can set the citation source so that it is properly cited.  You can find more information about this tag at: .<a href="http://www.w3schools.com/tags/tag_blockquote.asp">The blockquote attribute</a>.</span></p>
...
output result</pre>
	...
	<h3 class="action_title"> <span class="controllable" data-componentType="action-name" data-actionkey="GetCitationAddress">public action GetCitationAddress()</span></h3>

	<span class="controllable" data-componentType="action-description" data-actionkey="GetCitationAddress"><p>This action gets the citation URL or web address.</p></span>
<em>Returns</em>:<ul class="parameters">
	<li><strong>Libraries.Web.Attribute</strong>: The citation address.</li>
</ul>
	<span class="controllable" data-componentType="action-example" data-actionkey="GetCitationAddress"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.BlockQuote
use Libraries.Web.Attribute
BlockQuote blockQuote
blockQuote:SetCitationAddress("http://www.w3schools.com/tags/tag_blockquote.asp")
Attribute address = blockQuote:GetCitationAddress()</pre>

</div><div class="action">
	<h3 class="action_title"> <span class="controllable" data-componentType="action-name" data-actionkey="SetCitationAddress:text">public action SetCitationAddress(text value)</span></h3>

	<span class="controllable" data-componentType="action-description" data-actionkey="SetCitationAddress:text"><p>This action sets the citation URL or web address.</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The citation URL or web address.</span></li>

</ul>

	<span class="controllable" data-componentType="action-example" data-actionkey="SetCitationAddress:text"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.BlockQuote
use Libraries.Web.Attribute
BlockQuote blockQuote
blockQuote:SetCitationAddress("http://www.w3schools.com/tags/tag_blockquote.asp")</pre>
