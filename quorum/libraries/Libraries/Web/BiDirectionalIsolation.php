<?php $classPageTitle = "BiDirectionalIsolation"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.BiDirectionalIsolation</h1>
<input type="hidden" id="classkey" value="Libraries.Web.BiDirectionalIsolation" /><h2> <span class="controllable" data-componentType="class-name">Class BiDirectionalIsolation</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The BiDirectionalIsolation class represents HTML's (Hypertext Markup Language) bdi tag which is used to isloate text a piece of text that may be formatted in a different direction than the rest of the text.  You can find more information about this tag at: .<a href="http://www.w3schools.com/tags/tag_bdi.asp">The bdi attribute</a>.</span></p>
