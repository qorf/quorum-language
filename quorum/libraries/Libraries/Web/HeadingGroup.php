<?php $classPageTitle = "HeadingGroup"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.HeadingGroup</h1>
<input type="hidden" id="classkey" value="Libraries.Web.HeadingGroup" /><h2> <span class="controllable" data-componentType="class-name">Class HeadingGroup</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The HeaderGroup class represents HTML's (Hypertext Markup Language) hgroup tag which is used to group mulitple Headings. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_hgroup.asp">The hgroup attribute</a>.</span></p>
