<?php $classPageTitle = "UnderlineText"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.UnderlineText</h1>
<input type="hidden" id="classkey" value="Libraries.Web.UnderlineText" /><h2> <span class="controllable" data-componentType="class-name">Class UnderlineText</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The UnderlineText class represents HTML's (Hypertext Markup Language) u tag which is used to underline text. Can be used to point out misspelled words. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_u.asp">The u attribute</a>.</span></p>
