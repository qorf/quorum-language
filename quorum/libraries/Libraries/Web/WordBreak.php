<?php $classPageTitle = "WordBreak"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.WordBreak</h1>
<input type="hidden" id="classkey" value="Libraries.Web.WordBreak" /><h2> <span class="controllable" data-componentType="class-name">Class WordBreak</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The WordBreak class represents HTML's (Hypertext Markup Language) wbr tag which is used to add words that are ok to brake up when the page gets shrunk down. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_wbr.asp">The wbr attribute</a>.</span></p>
