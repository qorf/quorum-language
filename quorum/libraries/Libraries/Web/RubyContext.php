<?php $classPageTitle = "RubyContext"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.RubyContext</h1>
<input type="hidden" id="classkey" value="Libraries.Web.RubyContext" /><h2> <span class="controllable" data-componentType="class-name">Class RubyContext</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The RubyContext class represents HTML's (Hypertext Markup Language) rt tag which is used to give a pronunciation of characters in a ruby annotation. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_rt.asp">The rt attribute</a>.</span></p>
