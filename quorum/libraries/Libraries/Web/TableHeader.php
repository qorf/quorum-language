<?php $classPageTitle = "TableHeader"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.TableHeader</h1>
<input type="hidden" id="classkey" value="Libraries.Web.TableHeader" /><h2> <span class="controllable" data-componentType="class-name">Class TableHeader</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The TableHeader class represents HTML's (Hypertext Markup Language) thead tag which is used to group the TableHeaderCells of a table. This will be displayed before the TableBody. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_thead.asp">The thead attribute</a>.</span></p>
