<?php $classPageTitle = "Column"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Column</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Column" /><h2> <span class="controllable" data-componentType="class-name">Class Column</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Column class represents HTML's (Hypertext Markup Language) col tag which allows an entire column to be formatted and controlled from one element instead of each cell in a table. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_col.asp">The col attribute</a>.</span></p>
...
output result</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="GetSpan"><p>This action gets the span attribute of the column. The span is the number of columns group encompasses.</p></span>
<em>Returns</em>:<ul class="parameters">
...
<pre class="code">use Libraries.Web.Column
use Libraries.Web.Attribute
Column col
Attribute span = col:GetSpan()</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="SetSpan:integer"><p>This action sets the span attribute of the column. The span attribute is the number of column the group encompasses.</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>integer</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The span.</span></li>
