<?php $classPageTitle = "Emphasize"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Emphasize</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Emphasize" /><h2> <span class="controllable" data-componentType="class-name">Class Emphasize</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Emphasize class represents HTML's (Hypertext Markup Language) em tag which is used to emphasize/ittalcize text. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_phrase_elements.asp">The em attribute</a>.</span></p>
