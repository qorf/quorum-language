<?php $classPageTitle = "Paragraph"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Paragraph</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Paragraph" /><h2> <span class="controllable" data-componentType="class-name">Class Paragraph</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Paragraph class represents HTML's (Hypertext Markup Language) p tag which is used to group text in paragraph format. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_p.asp">The p attribute</a>.</span></p>
