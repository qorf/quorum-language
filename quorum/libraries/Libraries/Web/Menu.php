<?php $classPageTitle = "Menu"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Menu</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Menu" /><h2> <span class="controllable" data-componentType="class-name">Class Menu</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Menu class represents HTML's (Hypertext Markup Language) menu tag which is used to add a menu of controls to the page. **This is not currently supported in any major browser.** You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_menu.asp">The menu attribute</a>.</span></p>
...
<ul class="variables"><li class = "package_standard" ><strong>text</strong> <em>contextMenuType</em></li>
<li class = "package_alternate" ><strong>text</strong> <em>listMenuType</em></li>
<li class = "package_standard" ><strong>text</strong> <em>toolbarMenuType</em></li>
</ul>
 <h2> Actions</h2> 
<div class="action">
...
output result</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="GetLabel"><p>This action gets label of the menu.</p></span>
<em>Returns</em>:<ul class="parameters">
	<li><strong>Libraries.Web.Attribute</strong>: The label of specified menu</li>
</ul>
	<span class="controllable" data-componentType="action-example" data-actionkey="GetLabel"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.Menu
use Libraries.Web.Attribute
Menu menu
Attribute menuLabel = menu:GetLabel()</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="GetType"><p>This action gets type of the menu.</p></span>
<em>Returns</em>:<ul class="parameters">
	<li><strong>Libraries.Web.Attribute</strong>: The type of specified menu</li>
</ul>
	<span class="controllable" data-componentType="action-example" data-actionkey="GetType"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.Menu
use Libraries.Web.Attribute
Menu menu
Attribute menuType = menu:GetType()</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="SetLabel:text"><p>This action sets label on the menu.</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value"></span></li>
...
menu:SetLabel("aLabel")</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="SetType:text"><p>This action sets type of the menu.</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value"></span></li>
...
<pre class="code">use Libraries.Web.Menu
Menu menu
menu:SetType(menu:toolbarMenuType)</pre>
