<?php $classPageTitle = "Title"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Title</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Title" /><h2> <span class="controllable" data-componentType="class-name">Class Title</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Title class represents HTML's (Hypertext Markup Language) title tag which is the title for a webpage. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_title.asp">The title attribute</a>.</span></p>
