<?php $classPageTitle = "Division"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Division</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Division" /><h2> <span class="controllable" data-componentType="class-name">Class Division</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Division class represents HTML's (Hypertext Markup Language) div tag which contains a section in the body of the webpage. It is a way to divide the component of your webpage into parts or sections. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_div.asp">The div attribute</a>.</span></p>
