<?php $classPageTitle = "SmallText"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.SmallText</h1>
<input type="hidden" id="classkey" value="Libraries.Web.SmallText" /><h2> <span class="controllable" data-componentType="class-name">Class SmallText</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The SmallText class represents HTML's (Hypertext Markup Language) small tag which is used to add smaller text for side comments or copyrights. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_small.asp">The small attribute</a>.</span></p>
