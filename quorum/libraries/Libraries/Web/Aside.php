<?php $classPageTitle = "Aside"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Aside</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Aside" /><h2> <span class="controllable" data-componentType="class-name">Class Aside</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Aside class represents HTML's (Hypertext Markup Language) aside tag which is used to define content aside from the content it is placed in. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_aside.asp">The aside attribute</a>.</span></p>
