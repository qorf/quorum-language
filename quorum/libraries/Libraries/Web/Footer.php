<?php $classPageTitle = "Footer"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Footer</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Footer" /><h2> <span class="controllable" data-componentType="class-name">Class Footer</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Footer class represents HTML's (Hypertext Markup Language) footer tag which is used to add information like the author or copyright to the end of the page. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_footer.asp">The footer attribute</a>.</span></p>
