<?php $classPageTitle = "TableRow"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.TableRow</h1>
<input type="hidden" id="classkey" value="Libraries.Web.TableRow" /><h2> <span class="controllable" data-componentType="class-name">Class TableRow</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The TableRow class represents HTML's (Hypertext Markup Language) option tag which is a row in HTMLs (Hypertext Markup Language) table element. A TableRow can contain multiple TableHeaders(header cell) or TableDatas(cells) to form a table. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_tr.asp">The tr attribute</a>.</span></p>
