<?php $classPageTitle = "Link"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Link</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Link" /><h2> <span class="controllable" data-componentType="class-name">Class Link</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Link class represents HTML's (Hypertext Markup Language) a tag which is a way to add links to other web pages to your page. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_a.asp">The a attribute</a>.</span></p>
...
output result</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="GetAddress"><p>This action gets the address attribute of the link. The address is the location of the linked webpage or document.</p></span>
<em>Returns</em>:<ul class="parameters">
...
<pre class="code">use Libraries.Web.Link
use Libraries.Web.Attribute
Link link
Attribute address = link:GetAddress()</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="GetLanguageCode"><p>This action gets the language code attribute of the link. The language code is the two letter code corresponding to a language. See the Libraries.Web.LanguageCode class.</p></span>
<em>Returns</em>:<ul class="parameters">
...
use Libraries.Web.Attribute
Link link
Attribute code = link:GetLanguageCode()</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="GetMedia"><p>This action gets the media attribute of the link. The media tag specifies the type of media the link will be displayed on (e.g. handheld).</p></span>
<em>Returns</em>:<ul class="parameters">
...
use Libraries.Web.Attribute
Link link
Attribute media = link:GetMedia()</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="GetRelationship"><p>This action gets the relationship attribute of the link. The relationship tag specifies the type of relationship between the link and the current page.</p></span>
<em>Returns</em>:<ul class="parameters">
	<li><strong>Libraries.Web.Attribute</strong>: The type of relationship between the current page and link.</li>
</ul>
	<span class="controllable" data-componentType="action-example" data-actionkey="GetRelationship"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.Link
use Libraries.Web.Attribute
Link link
Attribute relationship = link:GetRelationship()</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="GetTarget"><p>This action gets the target attribute of the link. The target tag specifies where the link is to be opened.</p></span>
<em>Returns</em>:<ul class="parameters">
	<li><strong>Libraries.Web.Attribute</strong>: The place the link will be opened.</li>
</ul>
	<span class="controllable" data-componentType="action-example" data-actionkey="GetTarget"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.Link
use Libraries.Web.Attribute
Link link
Attribute target = link:GetTarget()</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="GetType"><p>This action gets the MIME type attribute of the link. The type attribute maps to a MIME type of the linked document.</p></span>
<em>Returns</em>:<ul class="parameters">
	<li><strong>Libraries.Web.Attribute</strong>: The MIME type attribute of the link.</li>
</ul>
	<span class="controllable" data-componentType="action-example" data-actionkey="GetType"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.Link
use Libraries.Web.Attribute
Link link
Attribute type = link:GetType()</pre>
	...
	<p>This action sets the address attribute of the link. The address is the location of the linked webpage or document.</p><span class="controllable" data-componentType="action-description" data-actionkey="SetAddress:text"><p>This needs to have a http:// or https:// at the start of the address.</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The address of a webpage or document.</span></li>
...
use Libraries.Web.Attribute
Link link
link:SetAddress("http://www.google.com")</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="SetLanguageCode:text"><p>This action sets the language code attribute of the link. The language code is the two letter code corresponding to a language. See the Libraries.Web.LanguageCode class.</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The two letter language code.</span></li>
...
link:SetLanguageCode(language:english)</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="SetMedia:text"><p>This action sets the media attribute of the link. The media tag specifies the type of media the link will be displayed on (e.g. handheld).</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The type of media the page will be displayed on (braille, handheld, aural, print, screen, etc.)</span></li>
...
link:SetRelationship("next")</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="SetTarget:text"><p>This action sets the target attribute of the link. The target tag specifies where the link is to be opened. These include: _blank, _self, _parent, _top, framename</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The target of the link.</span></li>
...
link:SetTarget("_top")</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="SetType:text"><p>This action sets the Type attribute of the link. The type attribute maps to a MIME type of the linked document</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The MIME type of the link.</span></li>
