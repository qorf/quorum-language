<?php $classPageTitle = "Article"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Article</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Article" /><h2> <span class="controllable" data-componentType="class-name">Class Article</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Article class represents HTML's (Hypertext Markup Language) article tag which is used to group text for self contained content. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_article.asp">The article attribute</a>.</span></p>
