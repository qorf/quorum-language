<?php $classPageTitle = "Legend"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Legend</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Legend" /><h2> <span class="controllable" data-componentType="class-name">Class Legend</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Legend class represents HTML's (Hypertext Markup Language) legend tag which is used to add a caption to the FieldSet class. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_legend.asp">The legend attribute</a>.</span></p>
