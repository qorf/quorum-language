<?php $classPageTitle = "ImageMap"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.ImageMap</h1>
<input type="hidden" id="classkey" value="Libraries.Web.ImageMap" /><h2> <span class="controllable" data-componentType="class-name">Class ImageMap</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The ImageMap class represents HTML's (Hypertext Markup Language) map tag which is used to make an image with different clickable areas. These areas are defined by the Area class. Multiple areas can be added to one map. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_map.asp">The map attribute</a>.</span></p>
...
output result</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="GetName"><p>This action gets name of the image map.</p></span>
<em>Returns</em>:<ul class="parameters">
	<li><strong>Libraries.Web.Attribute</strong>: The Attribute containing the name of the image map.</li>
</ul>
	<span class="controllable" data-componentType="action-example" data-actionkey="GetName"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.ImageMap
use Libraries.Web.Attribute
ImageMap imageMap
imageMap:SetName("testMap")
Attribute name = imageMap:GetName()</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="SetName:text"><p>This action sets the name of the image map.</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The imageMap name.</span></li>
