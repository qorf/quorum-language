<?php $classPageTitle = "StrikeThrough"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.StrikeThrough</h1>
<input type="hidden" id="classkey" value="Libraries.Web.StrikeThrough" /><h2> <span class="controllable" data-componentType="class-name">Class StrikeThrough</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The StrikeThrough class represents HTML's (Hypertext Markup Language) s tag which is used to strike through text that is no longer correct. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_s.asp">The s attribute</a>.</span></p>
