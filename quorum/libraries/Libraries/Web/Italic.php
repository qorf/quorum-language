<?php $classPageTitle = "Italic"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Italic</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Italic" /><h2> <span class="controllable" data-componentType="class-name">Class Italic</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Italic class represents HTML's (Hypertext Markup Language) i tag which italisizes a webpages text group. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_i.asp">The i attribute</a>.</span></p>
