<?php $classPageTitle = "SubscriptText"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.SubscriptText</h1>
<input type="hidden" id="classkey" value="Libraries.Web.SubscriptText" /><h2> <span class="controllable" data-componentType="class-name">Class SubscriptText</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The SubscriptText class represents HTML's (Hypertext Markup Language) sub tag which is used to add subscriptted text. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_sub.asp">The sub attribute</a>.</span></p>
