<?php $classPageTitle = "Bold"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Bold</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Bold" /><h2> <span class="controllable" data-componentType="class-name">Class Bold</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Bold class represents HTML's (Hypertext Markup Language) b tag which specifies bold text and should only be used as a last resort. A better approach would be to use CSS's "font-weight". You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_b.asp">The b attribute</a>.</span></p>
