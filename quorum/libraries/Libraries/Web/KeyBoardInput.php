<?php $classPageTitle = "KeyBoardInput"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.KeyBoardInput</h1>
<input type="hidden" id="classkey" value="Libraries.Web.KeyBoardInput" /><h2> <span class="controllable" data-componentType="class-name">Class KeyBoardInput</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The KeyBoardInput class represents HTML's (Hypertext Markup Language) kbd tag which is used to define keyboard input. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_phrase_elements.asp">The kbd attribute</a>.</span></p>
