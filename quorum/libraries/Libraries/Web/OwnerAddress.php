<?php $classPageTitle = "OwnerAddress"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.OwnerAddress</h1>
<input type="hidden" id="classkey" value="Libraries.Web.OwnerAddress" /><h2> <span class="controllable" data-componentType="class-name">Class OwnerAddress</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The OwnerAddress class represents HTML's (Hypertext Markup Language) address tag which defines the contact information for the author/owner of a document. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_address.asp">The address attribute</a>.</span></p>
