<?php $classPageTitle = "Highlight"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Highlight</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Highlight" /><h2> <span class="controllable" data-componentType="class-name">Class Highlight</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Highlight class represents HTML's (Hypertext Markup Language) mark tag which is used to highlight text. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_mark.asp">The mark attribute</a>.</span></p>
