<?php $classPageTitle = "SampleOutput"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.SampleOutput</h1>
<input type="hidden" id="classkey" value="Libraries.Web.SampleOutput" /><h2> <span class="controllable" data-componentType="class-name">Class SampleOutput</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The SampleOutput class represents HTML's (Hypertext Markup Language) samp tag which is used to show sample output of a computer program. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_samp.asp">The samp attribute</a>.</span></p>
