<?php $classPageTitle = "Deleted"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Deleted</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Deleted" /><h2> <span class="controllable" data-componentType="class-name">Class Deleted</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Deleted class represents HTML's (Hypertext Markup Language) del tag which is used to show that text has been deleted from a document. This strikes through the deleted text. Citation of the text can be added, as well as, a time stamp of when the text was deleted.  You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_del.asp">The del attribute</a>.</span></p>
...
<pre class="code">use Libraries.Web.Deleted
use Libraries.Web.Attribute
Deleted deleted
deleted:SetCitation("http://www.w3schools.com/tags/tag_del.asp")
Attribute address = deleted:GetCitation()</pre>

</div><div class="action">
	<h3 class="action_title"> <span class="controllable" data-componentType="action-name" data-actionkey="GetDeletedTime">public action GetDeletedTime()</span></h3>

	<span class="controllable" data-componentType="action-description" data-actionkey="GetDeletedTime"><p>This action gets the set deleted time of the text.</p></span>
<em>Returns</em>:<ul class="parameters">
	<li><strong>Libraries.Web.Attribute</strong>: The date time of the deleted text.</li>
</ul>
	<span class="controllable" data-componentType="action-example" data-actionkey="GetDeletedTime"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.Deleted
use Libraries.Web.Attribute
Deleted deleted
deleted:SetDeletedTime("2011-11-15T22:55:03Z")
Attribute dateTime = deleted:GetDeletedTime()</pre>
...
<pre class="code">use Libraries.Web.Deleted
Deleted deleted
deleted:SetCitation("http://www.w3schools.com/tags/tag_del.asp")</pre>

</div><div class="action">
	<h3 class="action_title"> <span class="controllable" data-componentType="action-name" data-actionkey="SetDeletedTime:text">public action SetDeletedTime(text value)</span></h3>

	<span class="controllable" data-componentType="action-description" data-actionkey="SetDeletedTime:text"><p>This action sets the deleted time of the text.</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The date and time.</span></li>

</ul>

	<span class="controllable" data-componentType="action-example" data-actionkey="SetDeletedTime:text"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.Deleted
Deleted deleted
deleted:SetDeletedTime("2011-11-15T22:55:03Z")</pre>
