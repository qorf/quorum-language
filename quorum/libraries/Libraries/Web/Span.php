<?php $classPageTitle = "Span"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Span</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Span" /><h2> <span class="controllable" data-componentType="class-name">Class Span</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Span class represents HTML's (Hypertext Markup Language) span tag which is a tag used to group text. Span does not modify the format directly but its attributes can be used to modify the spans appearance.</span></p>
