<?php $classPageTitle = "LineBreak"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.LineBreak</h1>
<input type="hidden" id="classkey" value="Libraries.Web.LineBreak" /><h2> <span class="controllable" data-componentType="class-name">Class LineBreak</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The LineBreak class represents HTML's (Hypertext Markup Language) br tag which creates a new line. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_br.asp">The br attribute</a>.</span></p>
