<?php $classPageTitle = "SuperscriptText"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.SuperscriptText</h1>
<input type="hidden" id="classkey" value="Libraries.Web.SuperscriptText" /><h2> <span class="controllable" data-componentType="class-name">Class SuperscriptText</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The SubscriptText class represents HTML's (Hypertext Markup Language) sup tag which is used to add superscriptted text. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_sup.asp">The sup attribute</a>.</span></p>
