<?php $classPageTitle = "StrongText"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.StrongText</h1>
<input type="hidden" id="classkey" value="Libraries.Web.StrongText" /><h2> <span class="controllable" data-componentType="class-name">Class StrongText</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The StrongText class represents HTML's (Hypertext Markup Language) strong tag which is used to bold text to show emphasis. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_strong.asp">The strong attribute</a>.</span></p>
