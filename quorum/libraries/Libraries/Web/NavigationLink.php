<?php $classPageTitle = "NavigationLink"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.NavigationLink</h1>
<input type="hidden" id="classkey" value="Libraries.Web.NavigationLink" /><h2> <span class="controllable" data-componentType="class-name">Class NavigationLink</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The NavigationLink class represents HTML's (Hypertext Markup Language) nav tag which is used to define a section of navigation links. This is meant for having a larger group of links together. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_nav.asp">The nav attribute</a>.</span></p>
