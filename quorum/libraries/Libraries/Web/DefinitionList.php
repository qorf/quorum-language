<?php $classPageTitle = "DefinitionList"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.DefinitionList</h1>
<input type="hidden" id="classkey" value="Libraries.Web.DefinitionList" /><h2> <span class="controllable" data-componentType="class-name">Class DefinitionList</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The DefinitionList class represents HTML's (Hypertext Markup Language) dl tag which is used to make a list for Definitions and DefinitionTerms. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_dl.asp">The dl attribute</a>.</span></p>
