<?php $classPageTitle = "UnorderedList"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.UnorderedList</h1>
<input type="hidden" id="classkey" value="Libraries.Web.UnorderedList" /><h2> <span class="controllable" data-componentType="class-name">Class UnorderedList</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The UnorderedList class represents HTML's (Hypertext Markup Language) ul tag which is used to add an unordered list to the page. Use ListItem to add to the list. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_ul.asp">The ul attribute</a>.</span></p>
