<?php $classPageTitle = "Figure"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Figure</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Figure" /><h2> <span class="controllable" data-componentType="class-name">Class Figure</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Figure class represents HTML's (Hypertext Markup Language) figure tag which is used to define self contained content like an image or diagram that can be used for reference. Use the FigureCaption to add a description to the Figure.  You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_figure.asp">The figure attribute</a>.</span></p>
