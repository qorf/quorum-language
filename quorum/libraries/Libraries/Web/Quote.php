<?php $classPageTitle = "Quote"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Quote</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Quote" /><h2> <span class="controllable" data-componentType="class-name">Class Quote</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Quote class represents HTML's (Hypertext Markup Language) q tag which is used to add a short quote. The quotation marks will be added to the text. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_q.asp">The q attribute</a>.</span></p>
...
<pre class="code">use Libraries.Web.Quote
use Libraries.Web.Attribute
Quote q
q:SetCitation("www.w3schools.com/tags/tag_blockquote.asp")
Attribute address = q:GetCitation()</pre>
...
<pre class="code">use Libraries.Web.Quote
Quote q
q:SetCitation("www.w3schools.com/tags/tag_blockquote.asp")</pre>
