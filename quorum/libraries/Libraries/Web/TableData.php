<?php $classPageTitle = "TableData"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.TableData</h1>
<input type="hidden" id="classkey" value="Libraries.Web.TableData" /><h2> <span class="controllable" data-componentType="class-name">Class TableData</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The TableData class represents HTML's (Hypertext Markup Language) td tag which is often contained in a TableRow. A TableData object represents a general and singular cell in a table. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_td.asp">The td attribute</a>.</span></p>
...
<pre class="code">use Libraries.Web.TableData
TableData td
integer span = td:GetColumnSpan()</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="GetHeaders"><p>This action gets the header id of a cell in a table.</p></span>
<em>Returns</em>:<ul class="parameters">
...
TableData td
Attribute headerID = td:GetHeaders()</pre>
...
<pre class="code">use Libraries.Web.TableData
TableData td
integer rowSpan = td:GetRowSpan()</pre>
...
td:SetColumnSpan(2)</pre>
	...
	<span class="controllable" data-componentType="action-description" data-actionkey="SetHeaders:text"><p>This action sets the header id that links this cell to a header (see TableHeader).</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The header id that links the cell to a header.</span></li>
