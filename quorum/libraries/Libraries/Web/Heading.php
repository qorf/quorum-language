<?php $classPageTitle = "Heading"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Heading</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Heading" /><h2> <span class="controllable" data-componentType="class-name">Class Heading</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Heading class represents HTML's (Hypertext Markup Language) h1-h6 (headings) tag which is used add titles to a page.  Headings vary in size from a scale of 1-6. Where 1 is the largest and 6 is the smallest. Use SetScale to set which level you want to use.  You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_hn.asp">The heading attribute</a>.</span></p>
...
output result</pre>
	...
	<h3 class="action_title"> <span class="controllable" data-componentType="action-name" data-actionkey="SetScale:text">public action SetScale(text value)</span></h3>

	<span class="controllable" data-componentType="action-description" data-actionkey="SetScale:text"><p>This action sets the scale of the header. A scale of 1 is equivalent to the tag h1 and 6 is equivalent to h6.</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The scale of the header.</span></li>

</ul>

	<span class="controllable" data-componentType="action-example" data-actionkey="SetScale:text"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.Heading
Heading heading
heading:SetScale(1)</pre>
