<?php $classPageTitle = "DefinitionListTerm"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.DefinitionListTerm</h1>
<input type="hidden" id="classkey" value="Libraries.Web.DefinitionListTerm" /><h2> <span class="controllable" data-componentType="class-name">Class DefinitionListTerm</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The DefinitionListTerm class represents HTML's (Hypertext Markup Language) dt tag which is used to ittalcize a word that will be defined by a following definition. This is meant to be used in a DefinitionList. For single definitions use DefinitionTerm.  You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_dt.asp">The dt attribute</a>.</span></p>
