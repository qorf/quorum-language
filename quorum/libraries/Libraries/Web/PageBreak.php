<?php $classPageTitle = "PageBreak"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.PageBreak</h1>
<input type="hidden" id="classkey" value="Libraries.Web.PageBreak" /><h2> <span class="controllable" data-componentType="class-name">Class PageBreak</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The PageBreak class represents HTML's (Hypertext Markup Language) hr tag which is used to add a line through the page showing a break in content. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_hr.asp">The hr attribute</a>.</span></p>
