<?php $classPageTitle = "ListOptions"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.ListOptions</h1>
<input type="hidden" id="classkey" value="Libraries.Web.ListOptions" /><h2> <span class="controllable" data-componentType="class-name">Class ListOptions</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The ListOptions class represents HTML's (Hypertext Markup Language) datalist tag which is used to contain pre-defined Options for an Input class.  This is used on the input by setting the SetList on input to the same as the id of the ListOptions.  You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_datalist.asp">The datalist attribute</a>.</span></p>
