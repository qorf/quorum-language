<?php $classPageTitle = "NoRuby"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.NoRuby</h1>
<input type="hidden" id="classkey" value="Libraries.Web.NoRuby" /><h2> <span class="controllable" data-componentType="class-name">Class NoRuby</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The NoRuby class represents HTML's (Hypertext Markup Language) rp tag which is used to show different content if browser does not support the Ruby annotations. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_rp.asp">The rp attribute</a>.</span></p>
