<?php $classPageTitle = "PreformattedText"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.PreformattedText</h1>
<input type="hidden" id="classkey" value="Libraries.Web.PreformattedText" /><h2> <span class="controllable" data-componentType="class-name">Class PreformattedText</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The PreformattedText class represents HTML's (Hypertext Markup Language) pre tag which is used to preserve line breaks and spaces that are in the text. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_pre.asp">The pre attribute</a>.</span></p>
