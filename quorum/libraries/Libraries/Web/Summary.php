<?php $classPageTitle = "Summary"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Summary</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Summary" /><h2> <span class="controllable" data-componentType="class-name">Class Summary</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Summary class represents HTML's (Hypertext Markup Language) summary tag which is used to add a title to a Details class. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_summary.asp">The summary attribute</a>.</span></p>
