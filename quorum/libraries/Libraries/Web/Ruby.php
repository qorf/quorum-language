<?php $classPageTitle = "Ruby"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Ruby</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Ruby" /><h2> <span class="controllable" data-componentType="class-name">Class Ruby</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Ruby class represents HTML's (Hypertext Markup Language) ruby tag which is used to Ruby annotations are used for East Asian typography, to show the pronunciation of East Asian characters. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_ruby.asp">The ruby attribute</a>.</span></p>
