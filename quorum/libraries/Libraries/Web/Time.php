<?php $classPageTitle = "Time"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.Time</h1>
<input type="hidden" id="classkey" value="Libraries.Web.Time" /><h2> <span class="controllable" data-componentType="class-name">Class Time</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The Time class represents HTML's (Hypertext Markup Language) time tag which is used to add a time reference to times on the page. It does not change how the text is shown but is used for search engines. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_time.asp">The time attribute</a>.</span></p>
...
output result</pre>
	...
	<h3 class="action_title"> <span class="controllable" data-componentType="action-name" data-actionkey="GetDateTime">public action GetDateTime()</span></h3>

	<span class="controllable" data-componentType="action-description" data-actionkey="GetDateTime"><p>This action gets the datetime of a time event. This allows the datetime to be hidden while a time is displayed. The following are valid datetime formats: YYYY-MM-DDThh:mm:ssTZD. That is YYYY(e.g. 2012), MM(e.g. 02), DD(e.g. 15), T(a seperator required for specifying time), hh(e.g. 23), mm(e.g. 30), ss(e.g. 05), TZD(e.g. Z for zulu).</p></span>
<em>Returns</em>:<ul class="parameters">
	<li><strong>Libraries.Web.Attribute</strong>: The datetime.</li>
</ul>
	<span class="controllable" data-componentType="action-example" data-actionkey="GetDateTime"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.Time
use Libraries.Web.Attribute
Time time
time:SetDateTime("2012-02-15T23:00:00Z")
Attribute dateTime = time:GetDateTime()</pre>

</div><div class="action">
	<h3 class="action_title"> <span class="controllable" data-componentType="action-name" data-actionkey="SetDateTime:text">public action SetDateTime(text value)</span></h3>

	<span class="controllable" data-componentType="action-description" data-actionkey="SetDateTime:text"><p>This action sets the datetime of a time event. This allows the datetime to be hidden while a time is displayed. The following are valid datetime formats: YYYY-MM-DDThh:mm:ssTZD. That is YYYY(e.g. 2012), MM(e.g. 02), DD(e.g. 15), T(a seperator required for specifying time), hh(e.g. 23), mm(e.g. 30), ss(e.g. 05), TZD(e.g. Z for zulu).</p></span><em>Parameters</em>:<ul class="parameters"><li><h5><span class="controllable" data-componentType="parameter-name" data-parameterkey="value"><strong>text</strong> <em>value</em>:</span></h5><span class="controllable" data-componentType="parameter-description" data-parameterkey="value">The datetime in any of the given formats.</span></li>

</ul>

	<span class="controllable" data-componentType="action-example" data-actionkey="SetDateTime:text"><em>Example Code:</em></span>
<pre class="code">use Libraries.Web.Time
Time time
time:SetDateTime("2012-02-15T23:00:00Z")</pre>
