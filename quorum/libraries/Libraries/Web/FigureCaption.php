<?php $classPageTitle = "FigureCaption"; ?><?php include('../../static/templates/pageheader.template.php'); ?><?php include('../../static/templates/classheader.template.php'); ?><h1 class="page_title"> Libraries.Web.FigureCaption</h1>
<input type="hidden" id="classkey" value="Libraries.Web.FigureCaption" /><h2> <span class="controllable" data-componentType="class-name">Class FigureCaption</span></h2> 
<p><span class="controllable" data-componentType="class-description"><em>Description</em>:
The FigureCaption class represents HTML's (Hypertext Markup Language) figcaption tag which is used to add a discription to a Figure. You can find more information about this tag at: <a href="http://www.w3schools.com/tags/tag_figcaption.asp">The figcaption attribute</a>.</span></p>
