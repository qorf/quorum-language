...
Finally, we need to increment our testing variable by one on each pass of the loop or it will repeat forever.  To do this, insert a line <code>testNumber = testNumber + 1</code> just after the end of the <code>if</code> block.</p></div>\n\
        </ul>";
    ...
    slideArray[3] = "<h5>Being Creative</h5>\n\
        ...
        <li>For this example, lets just use an <code>output</code> statement to print a message depending on whether the number is even or odd. You can also try a <code>say</code> statement if you want to hear it. Try something like <code>output testNumber + \" is even.\"</code> in the first block.</li>\n\
