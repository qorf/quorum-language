...
<script type="text/javascript">
    ...
    slideArray[0] = "<h5 role=\"heading\">This is where you will find my Notes.</h5><ul><li role=\"listitem\">My first experiment is to test some code.</li><li>Dr. Day already gave me some variables to test, he's so awesome.</li><li>Some strands aren't DNA(they have more than A, C, G, or T) but I will test them anyways.</li>";
