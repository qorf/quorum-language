...
<script type="text/javascript">
    ...
    slideArray[2] = "<h5 role=\"heading\">Make the Computer Talk with: Say</h5>\n\
        ...
        <span class=\"title\">Try it!</span>\n\
        <div class =\"task\">Tell the computer to say and output the result of the area calculation you just completed by typing a new line: <code>say \"The area is \" + area</code> followed by <code>output \"The area is \" + area</code></div>\n\
        </ul>"; //operators, concat
