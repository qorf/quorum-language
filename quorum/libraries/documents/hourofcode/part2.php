...
<script type="text/javascript">
    ...
    slideArray[0] = "<h5 role=\"heading\">Number Variables</h5><ul><li>Another type of variable used often in programming is a number.</li><li>A number variable holds numeric information such as 42 or 8.3439</li><li>Unlike text variables, we never need double quotes when storing a number.</li><span class=\"title\">Try it!</span><div class =\"task\">Create a number variable with the following code: <code>number pi = 3.14159</code>.</div></ul>";
