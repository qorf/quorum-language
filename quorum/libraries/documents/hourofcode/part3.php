...
<script type="text/javascript">
    ...
    slideArray[0] = "<h5 role=\"heading\">Hello again.</h5><ul><li role=\"listitem\">Dr. Day saw the mutation adn told me to run more tests.</li><li>My new goal is to find out how many times the mutation occurs, which could take a while.</li><li>But he gave me Cheetos, so it's okay.</li>";
    slideArray[1] = "<h5 role=\"heading\">Mary's Notes.</h5><ul><li role=\"listitem\">He taught me that in Quorum, I can use an if statement.</li><li>The if statement should tell me whether the clone is a mutant or not.</li><li>Then I think I can use an integer variable to store how many mutants I come across.</li>";
    slideArray[2] = "<h5 role=\"heading\">Mary's Notes.</h5><ul><li role=\"listitem\">The integer variable is named mutationCount.</li><li>And I could then put in the if statement, whatever that is.</li><li>If it does not equal GATTACA, its a mutant.</li>";
    slideArray[3] = "<h5 role=\"heading\">Mary's Notes.</h5><ul><li role=\"listitem\">I ended up with a TON of mutants.</li><li>It seemed pretty surprising but I didn't tell Dr. Day yet.</li><li>I guess we will find out what happens tomorrow.</li><li>I almost forgot, we got a pet rat.</li>";
