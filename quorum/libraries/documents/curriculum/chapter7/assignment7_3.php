...
<h2>Overview</h2>
<p>
    In this assignment you will create a program that builds hash tables. Each table you build will use a form of collision resolution called chaining. There are two general types: open addressing and closed addressing resolutions. Under closed addressing, there is a technique called chaining. Chaining is where you store colliding keys in a linked list at the same hash table index. For instance, if your hash function is (N mod 10), where <tt>N</tt> is your key value, and you input 60, 70, and 80, then all of those values will be stored in a linked list at index 0 in the hash table. Open addressing consists of techniques that store colliding keys elsewhere in the same table.
</p>
<p>
...
<p>
    Where <tt>n</tt> = number of elements stored in the hash table and <tt>a</tt> = load factor(the average length of a chain).
</p>
<p>
...
<h2>Class <tt>LinkedHashEntry</tt></h2>
<p>
    This class should contain two integer values: integer <tt>key</tt>, and integer <tt>value</tt>. It will also need an object of <tt>LinkedHashEntry</tt> that is set to undefined. You will need to create getters and setters for key, value, and your <tt>LinkedHashEntry</tt> object. This might look similar to this:
</p>
<pre class="code">
