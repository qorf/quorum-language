...
<script type="text/javascript">
    document.title = 'Lab 5.2: An Introduction to Class Variables and Access Modifiers | Quorum Programming Language';
</script>

<div class="hero-unit">
	<div class="hero-unit-container">
		<h1>Lab 5.2</h1>
                <p>An Introduction to Class Variables and Access Modifiers</p>
	</div>
</div>
