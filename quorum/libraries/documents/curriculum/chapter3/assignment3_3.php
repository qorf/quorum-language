...
<li>Modifying the existing program</li>
</ul>
<h2>Overview</h2>
<p>
...
[Input Dialog] How many people will be traveling? 2
...
[Input Dialog] Would you like to make a reservation for flights (Y/N)? w
Error: The input must be Y, y, N, or n. Please try again. You entered w
[Input Dialog] Would you like to make a reservation for flights (Y/N)? Y
[Input Dialog] Enter the destination number: 9
Error: The destination number must be between 1 and 8. Please try again. You entered 9
[Input Dialog] Enter the destination number: 2
[Input Dialog] Would you like to include hotel in your package (Y/N)? yy
...
[Input Dialog] Enter a number of hotel rooms: 1
[Input Dialog] Enter a number of nights to stay at the hotel: 0
Error: The number of nights must be one or more. Please try again. You entered 0
[Input Dialog] Enter a number of nights to stay at the hotel: 5
...
<ul>
<li>Create a new project and name it NewTravel.</li>
