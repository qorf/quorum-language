...
public class ArrayTester {
    ...
    @Test
    public void test_pass_Array_Get_First_Location_Not_Found_bytecode() {
        CompilerTestSuite.build(CompilerTestSuite.getQuorumFile(CompilerTestSuite.ARRAYS + CompilerTestSuite.PASS + "ArrayGetFirstLocationNotFound.quorum"));
        if (!vm.getCompilerErrors().isCompilationErrorFree()){
            fail();
        }
    ...
    @Test
    public void test_pass_Array_Get_First_Location_Found_execute() {
        CompilerTestSuite.build(CompilerTestSuite.getQuorumFile(CompilerTestSuite.ARRAYS + CompilerTestSuite.PASS + "ArrayGetFirstLocationFound.quorum"));
        if (!vm.getCompilerErrors().isCompilationErrorFree()) {
            fail();
        }
        vm.blockRun();
    ...
    @Test
    public void test_pass_Array_Get_First_Location_Found_bytecode() {
        CompilerTestSuite.build(CompilerTestSuite.getQuorumFile(CompilerTestSuite.ARRAYS + CompilerTestSuite.PASS + "ArrayGetFirstLocationFound.quorum"));
        if (!vm.getCompilerErrors().isCompilationErrorFree()){
            fail();
        }
