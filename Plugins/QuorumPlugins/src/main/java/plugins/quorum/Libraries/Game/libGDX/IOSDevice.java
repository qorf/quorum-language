...
/*
    A class used by the IOSDisplay in order to identify the device being used
    and thereby determine the proper number of pixels-per-inch.
*/
...
public enum IOSDevice {
	...
	final public String machineString;
	final public int ppi;
